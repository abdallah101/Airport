...
public class GreetingServer extends Thread
{
    ...
    class ServerThread implements Runnable
    {
        ...
        private boolean register(String username, String password, String fullName) throws SQLException {
            ...
            String insert = "INSERT INTO USER (Username,Password,Name,reserve_limit, Date) VALUES('" + username + "','" + password + "','" + fullName + "','" + 0 + "','" + dateFormat.format(date) + "')";
        ...
        //Check which gates have particular time slot user is asking for
            public String checkGates (String username, String timeslot) throws SQLException {
                ...
                {
                    out = "SELECT Time_slot, Gate_one, Gate_two, Gate_three, Gate_four, Gate_five, Gate_six, Gate_seven," +
                            "Gate_eight,Gate_nine, Gate_ten FROM gates WHERE Time_slot = '"+TS+"'";
